package nl.prime.software.auth.security.jwt;
...
public class JwtUtils {
	...
	@Value("${prime.app.jwtSecret}") // Call JWT Secret Key from application.properties
	private String jwtSecret;

	@Value("${prime.app.jwtExpirationMs}") // Call JWT Expiration time from application.properties
	...
	public String generateJwtToken(Authentication authentication) { // Generate JSON WebToken
		...
		return Jwts.builder() // Build JWT
				...
				.signWith(SignatureAlgorithm.HS512, jwtSecret) // Hash JWT with HS512 algorithm and CodeBean secret key
